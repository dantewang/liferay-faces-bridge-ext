...
import com.liferay.portlet.faces.RequestAttributeInspectorWrapper;
...
public class RequestAttributeInspectorLiferayImpl extends RequestAttributeInspectorWrapper implements Serializable {
	...
	private static final String EXCLUDED_NAMESPACE_JAKARTA_PORTLET_FACES = "com.liferay.portlet.faces";
	...
	public boolean containsExcludedNamespace(String name) {
		...
		if (isNamespaceMatch(name, EXCLUDED_NAMESPACE_JAKARTA_FACES) ||
			...
			// The "com.liferay.portlet.faces.phase" request attribute must never be excluded, as it is required by {@link
